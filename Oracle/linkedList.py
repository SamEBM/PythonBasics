# Linked List
# Is a linear data structure that stores elements everywhere in memory, thanks to the use of nodes.
# Is a list of nodes where each node contains the value stored and the address of the next node.
